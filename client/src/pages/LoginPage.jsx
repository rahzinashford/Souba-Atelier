...
const LoginPage = () => {
  ...
  useSEO({
    title: 'Login',
    description: 'Sign in to your Souba Atelier account to access your orders, wishlist, saved addresses, and enjoy faster checkout with personalized recommendations.'
  });
  ...
  const getRedirectPath = (userRole) => {
    ...
    const originalRedirect = location.state?.redirectTo;
    if (originalRedirect && originalRedirect !== '/admin') {
  ...
  const passwordError = touched.password && !formData.password ? 'Please enter your password' : '';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      success(loggedInUser.role === 'ADMIN' ? 'Welcome back, Admin!' : 'Welcome back!');
        ...
        <Card className="border-brand-primary/10 shadow-lg bg-white/80 backdrop-blur-sm">
          <CardHeader className="text-center pb-2">
            ...
            <CardDescription className="text-brand-text/60 italic">
              Login to continue shopping your saved outfits
            </CardDescription>
          </CardHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex justify-end mt-1">
                  <Link
                    to="#"
                    className="text-xs text-brand-primary/70 hover:text-brand-primary hover:underline transition-colors"
